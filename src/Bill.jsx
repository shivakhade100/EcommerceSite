    ...
    <div className="my-5 p-5"></div>
      {
        <div className="col-sm-12 col-md-6 col-lg-3">
          ...
          <div className="mybb">
            ...
            <div className="text-end pe-5 text-white h6">Date: {currentDate} </div>
            ...
            {CartItems.map((e, index) => {
              return (
                <div className="row text-white">
                  <div className="col-4 text-start h5 ps-5">{`${index + 1}) ${
                    e.name
                  }`}</div>
                  <div className="col-4">
                    <div className="">
            ...
            <div className="row text-white">
              <div className="col-10  text-end h5">Grand Total : </div>
              <div className="col-2 text-start pe-5 h5">Rs. {totalprice} </div>
            </div>
          </div>
        </div>
      }
